...
<div class="container-fluid">
	<!-- Page Heading -->
	<a href="<?= base_url('Masyarakat/PengaduanController') ?>" class="btn btn-dark"><i
	...
	<div class="card mb-3 col-lg-8">
		<div class="row no-gutters">
			...
			<div class="col-md-8">
				<div class="card-body">
					<h5 class="card-title">Laporan : <span class="text-dark">
					...
					<p class="card-text">Tanggapan : <span class="text-success">
							<?= $data_pengaduan['tanggapan'] ?>
						</span></p>
					<p class="card-text">Tgl Pengaduan : <span class="text-danger">
							<?= $data_pengaduan['tgl_pengaduan'] ?>
						</span></p>
					<p class="card-text">Tgl Tanggapan : <span class="text-danger">
							<?= $data_pengaduan['tgl_tanggapan'] ?>
						</span></p>
				</div>
			</div>
		</div>
